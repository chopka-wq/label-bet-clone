          ...
          <section className="container py-12 lg:py-20">
            ...
            <div className="text-center mb-16">
              <h1 className="text-3xl lg:text-5xl font-bold text-foreground mb-4">
                <span className="text-primary">{t.esports.title.split(' ')[0]}</span> {t.esports.title.split(' ').slice(1).join(' ')}
              </h1>
            ...
            <ImageTextSection
              title={
                <>
                  {t.esports.imageTextTitle.replace('Competitive Gaming', '').trim()}{' '}
            ...
            {/* Popular Games */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-foreground mb-6">{t.esports.popularGames}</h2>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground mb-6">{t.esports.majorTournaments}</h2>
